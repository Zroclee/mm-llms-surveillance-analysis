    ...
    loca.viewControl.addAnimates([{
      ...
      loca.viewControl.addAnimates(tourAnimates, function () {
        ...
        loca.viewControl.addAnimates([{
          ...
          zoom: {
            value: 12.8,
            control: [[0, 16.5], [1, 12.8]],
            timing: [0.3, 0, 0.7, 1],
            duration: 2500,
          },
          rotation: {
            value: 360,
            control: [[0, tourAnimates[tourAnimates.length - 1]?.rotation?.value || 0], [1, 360]],
            timing: [0.3, 0, 0.7, 1],
            duration: 2500,
          }
        }], function () {
