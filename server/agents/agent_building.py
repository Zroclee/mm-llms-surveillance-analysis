...
3. **结构性封顶**：主体结构（框架/剪力墙）全部完成，楼顶已浇筑混凝土，建筑物轮廓完全成型。
...
3.  **资金拨付节点符合性评估**：
    *   对照上述五个关键节点（开工、基础验收、结构性封顶、交付使用、决算），判断当前进度是否**达到或超过**申请的节点要求。
    *   如果未达到，请具体说明缺少的关键工程量（例如：申请封顶，但实际还在施工顶层钢筋）。

4.  **监管建议**：
    *   给出明确结论：**建议拨付** / **建议暂缓** / **需现场核查**。
    *   简述理由，为财政部门提供决策依据。"""
            ),
            HumanMessage(
                content=[
